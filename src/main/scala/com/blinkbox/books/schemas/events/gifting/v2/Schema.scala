...
case class RedemptionDetails(actionDetails: Map[String, String])

object Gift {
  case class Redeemed(campaign: Campaign, redemptionDetails: RedemptionDetails, userId: Int, redeemedAt: DateTime)
  ...
  implicit object Redeemed extends JsonEventBody[Redeemed] {
    ...
    def unapply(body: EventBody): Option[(Campaign, RedemptionDetails, Int, DateTime)] =
